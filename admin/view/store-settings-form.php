            ...
            <form method="POST" action="options.php" id="slwp-store-setting-form">
	            ...
	            <div class="tab-content">
	            	    ...
	            	    <div class="form-group">
	            	        ...
	            	        <div class="form-control-wrap">
	            	            ...
	            	            <span class="slwp-info">
	            	                <span class="slwp-info-text slwp-hide"><?php echo sprintf( __( 'Get your server key %shere%s.', 'slwp-stores' ), '<a href="https://console.developers.google.com/flows/enableapi?apiid=geocoding_backend&keyType=SERVER_SIDE&reusekey=true" target="_blank">', '</a>' ); ?>
	            	                </span>
	            	            </span>
	            	        </div>
	            	    </div>
					...
					<div id="general">
						...
						<div class="form-group">
	            	        <label for="slwp-browser-key"><?php _e( 'Google Map Api Key:', 'slwp-stores' ); ?></label>
	            	        <div class="form-control-wrap">
	            	            ...
	            	            <span class="slwp-info">
                                    <span class="slwp-info-text slwp-hide"><?php echo sprintf( __( 'Get your browser key %shere%s', 'slwp-stores' ), '<a href="https://console.developers.google.com/flows/enableapi?apiid=maps_backend,geocoding_backend,directions_backend,distance_matrix_backend,elevation_backend,places_backend&keyType=CLIENT_SIDE&reusekey=true" target="_blank">', '</a>' ); ?>
                                    </span>
                                </span>
	            	        </div>
	            	    </div>
